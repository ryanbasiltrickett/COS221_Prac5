...
<body>
    ...
    <div class="credentials">
            ...
            <h3>Please use the below to insert or update swimming locations</h3>

            <div id="main-buttons">
            <a href="addlocation.php"> <button id = "addLocation" type="button">Add Location</button></a>
            <a href="updatelocation.php"> <button id = "updateLocation" type="button">Update Location</button></a>
            </div>
